...
def eliminar_columnas_con_nulos(df: pd.DataFrame, umbral_porcentaje: float = 0.20) -> pd.DataFrame:
    ...
    print("-------------------------------------------------")
    print("Se ejecuta función eliminar_columnas_con_nulos()")
    print("-------------------------------------------------")
...
def imputar_valores(df: pd.DataFrame,
    ...
    total_cambios_cat = 0
    print("-------------------------------------------------")
    print("Se ejecuta función imputar_valores()")
    print("-------------------------------------------------")
...
def verificar_unicos_outliers(df: pd.DataFrame) -> List[str]:
    ...
    print("-------------------------------------------------")
    print("Se ejecuta función verificar_unicos_outliers()")
    print("-------------------------------------------------")
...
def detectar_outliers_iqr(df: pd.DataFrame, 
    ...
    print("-------------------------------------------------")
    print("Se ejecuta función detectar_outliers_iqr()")
    print("-------------------------------------------------")
...
def capping(df: pd.DataFrame, columnas: Iterable[str] = None) -> pd.DataFrame:
    ...
    print("-------------------------------------------------")
    print("Se ejecuta función capping()")
    print("-------------------------------------------------")
